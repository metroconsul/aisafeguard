...
export function AdminDashboard() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-semibold text-foreground">Dashboard — Administrador</h1>
        <p className="text-sm text-muted-foreground">Visão panorâmica e estratégica</p>
      </div>
